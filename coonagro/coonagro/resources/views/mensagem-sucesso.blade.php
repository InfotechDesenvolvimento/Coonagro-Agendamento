...
<div class="col-12">
    <div class="container" style="padding: 30px; text-align:center; border-radius: 15px; max-width: 750px; margin-top: 20px; background: #E8E8E8">
        ...
        <a style="text-decoration:none;" href="{{ action('FormController@imprimirAgendamentoOutros') }}"> <button style="margin-top: 7px; font-size: 17px" type="button" class="btn btn-primary btn-lg btn-block"> <i class="fas fa-print"></i> IMPRIMIR AGENDAMENTO</b></button> </a>
